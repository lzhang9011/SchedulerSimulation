...
//
//    private Map<Integer, Cluster> regionMap;
//
//    public RegionManager(Map<Integer, Cluster> regionMap) {
//        this.regionMap = regionMap;
//    }
//    public Cluster getRegion(int regionID) {
...
//        for (Map.Entry<Integer, Cluster> entry : regionMap.entrySet()) {
...
//        return parts;
//    }
//    public static Map<Integer, Cluster> readRegions(String file) {
//        Gson gson = new Gson();
//        Map<Integer, Cluster> regionMap = new HashMap<>();
//
//        try (FileReader reader = new FileReader(file)) {
//            Cluster[] clusters = gson.fromJson(reader, Cluster[].class);
//            if (clusters != null) {
//                for (Cluster cluster : clusters) {
//                    regionMap.put(cluster.getRegionID(), cluster);
//                }
//            } else {
...
//        Map<Integer, Cluster> regionMap = readRegions(regionsFile);
